...
describe('TrackingTable', () => {
  it('renders the table with correct mapping and status colors', () => {
    const orders = [
      { numero: 'PC0001', emissao: '2023-05-10', previsao: '2023-05-20', dias_previstos_entrega: 10, fornecedor: 'F1', centro_custo: 'C1', status: 'recebido' },
      { numero: 'PC0002', emissao: '2023/12/25', previsao: '2023/12/31', dias_previstos_entrega: 10, fornecedor: 'F2', centro_custo: 'C2', status: 'cancelado' },
      { numero: 'PC0003', emissao: null, previsao: null, dias_previstos_entrega: 10, fornecedor: 'F3', centro_custo: 'C3', status: 'aberto' },
      { numero: 'OTHER', emissao: '2023-05-10', previsao: '2023-05-20', dias_previstos_entrega: 10, fornecedor: 'F4', centro_custo: 'C4', status: 'em rota' },
      { numero: 'N/A', emissao: '2023-05-10', previsao: '2023-05-20', dias_previstos_entrega: 10, fornecedor: 'F5', centro_custo: 'C5', status: 'Unknown' },
      { numero: 'N/A_2', emissao: '2023-05-10', previsao: '2023-05-20', dias_previstos_entrega: 10, fornecedor: 'F6', centro_custo: 'C6', status: null }, // testing null status
    ];
