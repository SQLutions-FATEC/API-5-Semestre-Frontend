...
describe('TrackingCards', () => {
  const mockCompras = {
    pedidos: [
      { numero: '123', fornecedor: 'Fornecedor A', status: 'aberto', data_pedido: '2023-01-01', prioridade: 'Urgente' },
      { numero: '456', fornecedor: 'Fornecedor B', status: 'enviado', data_pedido: '2023-01-01', prioridade: 'Alta' },
      { numero: '789', fornecedor: 'Fornecedor C', status: 'recebido', data_pedido: '2023-01-01', prioridade: 'Baixa' }
    ]
  };
  ...
  const mockAlertas = {
    alertas_criticos: {
      ...
      pedidos_prioritarios_pendentes: [
        { numero_pedido: '123', prioridade: 'Urgente', status: 'aberto', data_pedido: '2023-01-01' },
